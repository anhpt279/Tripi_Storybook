...
// star rating display component（No items yet. Add one to get started.）
const StarRating: React.FC<{ rating: number; maxRating?: number }> = ({ 
  rating, 
  maxRating = 10 
}) => {
  // Convert a 0-10 rating into a 0-5 star rating
      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <Typography variant="muted" className="text-sm mb-2 line-clamp-2">
            Director: {movie.directors.join(', ')} / Cast: {movie.actors.join(', ')}
          </Typography>
